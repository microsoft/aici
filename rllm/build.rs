// this is copied from candle/candle-flash-attn/build.rs
// and modified to compile the kernels in this crate
...
fn main() -> Result<()> {
    ...
    let out_file = build_dir.join("librllmkernels.a");
    ...
    println!("cargo:rustc-link-lib=rllmkernels");
