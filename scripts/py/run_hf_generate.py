# This example embeds AICI in HuggingFace transformers when using
# model.generate() with Streamer and LogitsProcessor callbacks.
# This does not support backtracking or fast-forward tokens,
# see run_hf.py for an example calling directly into model with
# fast-forward and backtracking.
